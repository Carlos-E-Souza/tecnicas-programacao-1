...
bool Cartao::setValor(string valor){
    if(Cartao::isValido(valor)){
        this->valor = valor;
        return true;
    }
    throw invalid_argument("Digito verificador do cartao e invalido");
}

bool Cartao::isValido(string valor){
